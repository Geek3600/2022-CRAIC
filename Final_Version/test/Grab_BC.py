...
storage_cache_2="B1M1SetCmd;1;0;160;-35;0;1#"
storage_cache_3="B1M1SetCmd;1;50;160;-35;0;1#"
storage_cache_4="B1M1SetCmd;1;-50;210;-35;0;1#"
storage_cache_5="B1M1SetCmd;1;0;210;-35;0;1#"
storage_cache_6="B1M1SetCmd;1;50;210;-35;0;1#"
...
def callback(data):
    ...
    if data.status.status == 3:
        ...
        while C_nums:
            mark_c = goto_grab(C_label, storage_cache_coordinate[i])
            if mark_c == 0:
                break
            else:
                i = i + 1
        ...
        if mark_b == 0 or mark_c == 0:
            ...
            while B_nums:
                ...
                B_nums = B_nums - 1
            while C_nums:
                goto_grab(C_label, storage_cache_coordinate[i])
                i = i + 1
                C_nums= C_nums - 1
            go_home()
...
if __name__ == '__main__': 
    ...
    rospy.init_node('GrabBC', anonymous=True)
